<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="login.*,tendency.*,java.io.PrintWriter"%>
...
%>
        <!-- 성향테스트 -->
        <div class="back">
            <form method="post" action="/Project/tendencyPro.do?id_no=${id_no}">
            ...
            <div class="selectbox">
                ...
                <select id="starttime" name="starttime">
                    <option value="08:00" <%=tend.equals("08:00")?" selected":""%>>08:00</option>
                    <option value="09:00" <%=tend.equals("09:00")?" selected":""%>>09:00</option>
                    <option value="10:00" <%=tend.equals("10:00")?" selected":""%>>10:00</option>
                    <option value="11:00" <%=tend.equals("11:00")?" selected":""%>>11:00</option>
                    <option value="저녁출근" <%=tend.equals("저녁출근")?" selected":""%>>저녁출근</option>
                </select>
            </div>
            <div class="selectbox">
            ...
            <div class="checkbox">
                ...
                <input id="btn3" type="submit" value="취소">
            </form>
        </div>
        <!-- 꼬리말 -->
        <footer class="ft">
