...
<body>
    <div class="wrap">
        ...
        <div class="menu-bar">
            <ul class="menu">
                <li class="menu1"><a href="#">쉐어하우스</a></li>
                <li class="menu2"><a href="#">룸메이트</a></li>
                <li class="menu3"><a href="#">자유게시판</a></li>
                <li class="menu4"><a href="register.jsp">공지사항</a></li>
                <li class="menu5"><a href="#">성향테스트</a></li>
            </ul>
        </div>
        </header>
        ...
        <div class="login">
            <nav class="nav2">
                ...
                <form name="login" method="post" action="">
                    <input type="text" nama="mem_id" placeholder="아이디"><br>
                    <input type="password" name="mem_pw" placeholder="비밀번호">
                    <button type="button" class="login_btn" onclick="">로그인</button>
                </form>
                <br>
